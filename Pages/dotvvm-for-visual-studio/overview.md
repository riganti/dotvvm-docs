...
[DotVVM for Visual Studio](https://www.dotvvm.com/products/visual-studio-extensions) is an extension for **Visual Studio 2026, 2022 and 2019** which adds support for DotVVM projects.
...
**The extension supports the latest releases of Visual Studio 2026, 2022 and 2019.** If you don't see the extension in the _Extension Manager_ window, make sure you have installed the **latest updates of VS**.
